...
class RouterV1:
        ...
        return [
            ...
            RoutingRule(
                ...
                keywords=[
                    ...
                    "最新", "latest", "recent", "news", "新闻",
                    "什么是", "what is", "who is", "谁是",
                    "怎么样", "how about", "how is",
                    "在哪里", "where", "哪里"
                ],
                patterns=[
                    r".*搜索.*",
            ...
            RoutingRule(
                ...
                keywords=[
                    "引用", "来源", "citation", "source", "参考", "reference"
                ],
                patterns=[
                    r".*需要.*引用.*",
                    r".*标注.*来源.*",
            ...
            RoutingRule(
                ...
                keywords=[
                    "教学", "课程", "教案", "讲解", "teach", "lesson",
                    "学习", "learn", "教我", "teach me",
                    "练习", "exercise", "习题", "作业",
                    "课件", "教材", "知识点", "概念"
                ],
                patterns=[
            ...
            RoutingRule(
                ...
                keywords=[
                    "知识库", "文档", "document", "knowledge base",
                    "根据", "based on", "according to",
                    "资料", "材料", "reference",
                    "本地", "local", "内部", "internal"
                ],
                patterns=[
                    r".*根据.*文档.*",
                    r".*在.*知识库.*中.*",
    ...
    def route(
        ...
        candidates = [(wf, self._normalize_confidence(score, scores)) 
                     for wf, score in sorted_scores]

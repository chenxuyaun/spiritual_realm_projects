...
class ModelManager:
    ...
    def _load_model_from_path(
        ...
        try:
            ...
            self._logger.info(
                f"Model loaded successfully: {config.name}",
            ...
            raise ModelError(
                ...
                context={"model_name": config.name}
            )
    ...
    def load_model(
        ...
        if model_name in self._cache:
            ...
            self._logger.debug(
                ...
                context={"use_count": cached.use_count}
            )
            return cached

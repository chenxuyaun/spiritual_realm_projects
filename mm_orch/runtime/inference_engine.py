        ...
        **kwargs
        ...
        try:
            ...
            gen_kwargs["pad_token_id"] = (
                config.pad_token_id or self.tokenizer.pad_token_id
            )
            gen_kwargs["eos_token_id"] = (
                config.eos_token_id or self.tokenizer.eos_token_id
            )
            ...
            raise InferenceError(
                f"GPU out of memory during inference: {e}",
    ...
    def generate_stream(
        ...
        **kwargs
        ...
        try:
            ...
            raise InferenceError(
                f"Streaming inference failed: {e}",
                input_length=len(prompt)
            )
        ...
        **kwargs
        ...
        try:
            ...
            for i in range(batch_size):
                ...
                tokens_per_second = (
                    output_tokens / sample_time if sample_time > 0 else 0
                )
